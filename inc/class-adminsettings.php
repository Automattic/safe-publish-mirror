...
final class AdminSettings {
	const OPTION_GROUP = 'safe_publish_mirror_settings';
	...
	public function register_settings(): void {
		...
		add_settings_section(
			$settings_section,
			__( 'General Settings', 'safe-publish-mirror' ),
		...
		add_settings_field(
			'enabled',
			__( 'Enable plugin', 'safe-publish-mirror' ),
		...
		add_settings_field(
			'message',
			__( 'Message', 'safe-publish-mirror' ),
