...
/**
 * @covers Automattic\SafePublishMirror\SettingsValidator
 * @uses \Automattic\SafePublishMirror\Settings
 * @uses \Automattic\SafePublishMirror\InputFactory::__construct
...
class SettingsValidatorTest extends WP_UnitTestCase {
	 ...
	 * @uses \Automattic\SafePublishMirror\AdminSettings
	 * @param mixed $value
